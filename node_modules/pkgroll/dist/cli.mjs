...
`).map(N)),"b$1"),Mt=i(u=>{let e=[];for(let D of u){let{length:t}=D,n=t-e.length;for(let r=0;r<n;r+=1)e.push(0);for(let r=0;r<t;r+=1){let o=Ju(D[r]);o>e[r]&&(e[r]=o)}}return e},"k$1");x();var Gu=/^\d+%$/,Ku={width:"auto",align:"left",contentWidth:0,paddingLeft:0,paddingRight:0,paddingTop:0,paddingBottom:0,horizontalPadding:0,paddingLeftString:"",paddingRightString:""},Wt=i((u,e)=>{var D;let t=[];for(let n=0;n<u.length;n+=1){let r=(D=e[n])!=null?D:"auto";if(typeof r=="number"||r==="auto"||r==="content-width"||typeof r=="string"&&Gu.test(r)){t.push(fu(eu({},Ku),{width:r,contentWidth:u[n]}));continue}if(r&&typeof r=="object"){let o=fu(eu(eu({},Ku),r),{contentWidth:u[n]});o.horizontalPadding=o.paddingLeft+o.paddingRight,t.push(o);continue}throw new Error(`Invalid column width: ${JSON.stringify(r)}`)}return t},"sD");function Ut(u,e){for(let D of u){let{width:t}=D;if(t==="content-width"&&(D.width=D.contentWidth),t==="auto"){let a=Math.min(20,D.contentWidth);D.width=a,D.autoOverflow=D.contentWidth-a}if(typeof t=="string"&&Gu.test(t)){let a=Number.parseFloat(t.slice(0,-1))/100;D.width=Math.floor(e*a)-(D.paddingLeft+D.paddingRight)}let{horizontalPadding:n}=D,r=1,o=r+n;if(o>=e){let a=o-e,l=Math.ceil(D.paddingLeft/n*a),C=a-l;D.paddingLeft-=l,D.paddingRight-=C,D.horizontalPadding=D.paddingLeft+D.paddingRight}D.paddingLeftString=D.paddingLeft?" ".repeat(D.paddingLeft):"",D.paddingRightString=D.paddingRight?" ".repeat(D.paddingRight):"";let s=e-D.horizontalPadding;D.width=Math.max(Math.min(D.width,s),r)}}i(Ut,"aD");var Hu=i(()=>Object.assign([],{columns:0}),"G$1");function Vt(u,e){let D=[Hu()],[t]=D;for(let n of u){let r=n.width+n.horizontalPadding;t.columns+r>e&&(t=Hu(),D.push(t)),t.push(n),t.columns+=r}for(let n of D){let r=n.reduce((c,E)=>c+E.width+E.horizontalPadding,0),o=e-r;if(o===0)continue;let s=n.filter(c=>"autoOverflow"in c),a=s.filter(c=>c.autoOverflow>0),l=a.reduce((c,E)=>c+E.autoOverflow,0),C=Math.min(l,o);for(let c of a){let E=Math.floor(c.autoOverflow/l*C);c.width+=E,o-=E}let F=Math.floor(o/s.length);for(let c=0;c<s.length;c+=1){let E=s[c];c===s.length-1?E.width+=o:E.width+=F,o-=F}}return D}i(Vt,"lD");function zt(u,e,D){let t=Wt(D,e);return Ut(t,u),Vt(t,u)}i(zt,"Z$2"),x(),x(),x();var Fu=10,Zu=i((u=0)=>e=>`\x1B[${e+u}m`,"U$1"),Qu=i((u=0)=>e=>`\x1B[${38+u};5;${e}m`,"V$2"),Yu=i((u=0)=>(e,D,t)=>`\x1B[${38+u};2;${e};${D};${t}m`,"Y$1");function qt(){let u=new Map,e={modifier:{reset:[0,0],bold:[1,22],dim:[2,22],italic:[3,23],underline:[4,24],overline:[53,55],inverse:[7,27],hidden:[8,28],strikethrough:[9,29]},color:{black:[30,39],red:[31,39],green:[32,39],yellow:[33,39],blue:[34,39],magenta:[35,39],cyan:[36,39],white:[37,39],blackBright:[90,39],redBright:[91,39],greenBright:[92,39],yellowBright:[93,39],blueBright:[94,39],magentaBright:[95,39],cyanBright:[96,39],whiteBright:[97,39]},bgColor:{bgBlack:[40,49],bgRed:[41,49],bgGreen:[42,49],bgYellow:[43,49],bgBlue:[44,49],bgMagenta:[45,49],bgCyan:[46,49],bgWhite:[47,49],bgBlackBright:[100,49],bgRedBright:[101,49],bgGreenBright:[102,49],bgYellowBright:[103,49],bgBlueBright:[104,49],bgMagentaBright:[105,49],bgCyanBright:[106,49],bgWhiteBright:[107,49]}};e.color.gray=e.color.blackBright,e.bgColor.bgGray=e.bgColor.bgBlackBright,e.color.grey=e.color.blackBright,e.bgColor.bgGrey=e.bgColor.bgBlackBright;for(let[D,t]of Object.entries(e)){for(let[n,r]of Object.entries(t))e[n]={open:`\x1B[${r[0]}m`,close:`\x1B[${r[1]}m`},t[n]=e[n],u.set(r[0],r[1]);Object.defineProperty(e,D,{value:t,enumerable:!1})}return Object.defineProperty(e,"codes",{value:u,enumerable:!1}),e.color.close="\x1B[39m",e.bgColor.close="\x1B[49m",e.color.ansi=Zu(),e.color.ansi256=Qu(),e.color.ansi16m=Yu(),e.bgColor.ansi=Zu(Fu),e.bgColor.ansi256=Qu(Fu),e.bgColor.ansi16m=Yu(Fu),Object.defineProperties(e,{rgbToAnsi256:{value:i((D,t,n)=>D===t&&t===n?D<8?16:D>248?231:Math.round((D-8)/247*24)+232:16+36*Math.round(D/255*5)+6*Math.round(t/255*5)+Math.round(n/255*5),"value"),enumerable:!1},hexToRgb:{value:i(D=>{let t=/(?<colorString>[a-f\d]{6}|[a-f\d]{3})/i.exec(D.toString(16));if(!t)return[0,0,0];let{colorString:n}=t.groups;n.length===3&&(n=n.split("").map(o=>o+o).join(""));let r=Number.parseInt(n,16);return[r>>16&255,r>>8&255,r&255]},"value"),enumerable:!1},hexToAnsi256:{value:i(D=>e.rgbToAnsi256(...e.hexToRgb(D)),"value"),enumerable:!1},ansi256ToAnsi:{value:i(D=>{if(D<8)return 30+D;if(D<16)return 90+(D-8);let t,n,r;if(D>=232)t=((D-232)*10+8)/255,n=t,r=t;else{D-=16;let a=D%36;t=Math.floor(D/36)/5,n=Math.floor(a/6)/5,r=a%6/5}let o=Math.max(t,n,r)*2;if(o===0)return 30;let s=30+(Math.round(r)<<2|Math.round(n)<<1|Math.round(t));return o===2&&(s+=60),s},"value"),enumerable:!1},rgbToAnsi:{value:i((D,t,n)=>e.ansi256ToAnsi(e.rgbToAnsi256(D,t,n)),"value"),enumerable:!1},hexToAnsi:{value:i(D=>e.ansi256ToAnsi(e.hexToAnsi256(D)),"value"),enumerable:!1}}),e}i(qt,"AD");var Jt=qt(),Gt=Jt,tu=new Set(["\x1B","\x9B"]),Kt=39,Cu="\x07",Xu="[",Ht="]",ue="m",pu=`${Ht}8;;`,ee=i(u=>`${tu.values().next().value}${Xu}${u}${ue}`,"J$2"),te=i(u=>`${tu.values().next().value}${pu}${u}${Cu}`,"Q$1"),Zt=i(u=>u.split(" ").map(e=>N(e)),"hD"),du=i((u,e,D)=>{let t=[...e],n=!1,r=!1,o=N(qu(u[u.length-1]));for(let[s,a]of t.entries()){let l=N(a);if(o+l<=D?u[u.length-1]+=a:(u.push(a),o=0),tu.has(a)&&(n=!0,r=t.slice(s+1).join("").startsWith(pu)),n){r?a===Cu&&(n=!1,r=!1):a===ue&&(n=!1);continue}o+=l,o===D&&s<t.length-1&&(u.push(""),o=0)}!o&&u[u.length-1].length>0&&u.length>1&&(u[u.length-2]+=u.pop())},"S"),Qt=i(u=>{let e=u.split(" "),D=e.length;for(;D>0&&!(N(e[D-1])>0);)D--;return D===e.length?u:e.slice(0,D).join(" ")+e.slice(D).join("")},"cD"),Yt=i((u,e,D={})=>{if(D.trim!==!1&&u.trim()==="")return"";let t="",n,r,o=Zt(u),s=[""];for(let[l,C]of u.split(" ").entries()){D.trim!==!1&&(s[s.length-1]=s[s.length-1].trimStart());let F=N(s[s.length-1]);if(l!==0&&(F>=e&&(D.wordWrap===!1||D.trim===!1)&&(s.push(""),F=0),(F>0||D.trim===!1)&&(s[s.length-1]+=" ",F++)),D.hard&&o[l]>e){let c=e-F,E=1+Math.floor((o[l]-c-1)/e);Math.floor((o[l]-1)/e)<E&&s.push(""),du(s,C,e);continue}if(F+o[l]>e&&F>0&&o[l]>0){if(D.wordWrap===!1&&F<e){du(s,C,e);continue}s.push("")}if(F+o[l]>e&&D.wordWrap===!1){du(s,C,e);continue}s[s.length-1]+=C}D.trim!==!1&&(s=s.map(l=>Qt(l)));let a=[...s.join(`
`)];for(let[l,C]of a.entries()){if(t+=C,tu.has(C)){let{groups:c}=new RegExp(`(?:\\${Xu}(?<code>\\d+)m|\\${pu}(?<uri>.*)${Cu})`).exec(a.slice(l).join(""))||{groups:{}};if(c.code!==void 0){let E=Number.parseFloat(c.code);n=E===Kt?void 0:E}else c.uri!==void 0&&(r=c.uri.length===0?void 0:c.uri)}let F=Gt.codes.get(Number(n));a[l+1]===`
`?(r&&(t+=te("")),n&&F&&(t+=ee(F))):C===`
`&&(n&&F&&(t+=ee(n)),r&&(t+=te(r)))}return t},"dD");function Xt(u,e,D){return String(u).normalize().replace(/\r\n/g,`
`).split(`
`).map(t=>Yt(t,e,D)).join(`
`)}i(Xt,"T$1");var De=i(u=>Array.from({length:u}).fill(""),"X$1");function uD(u,e){let D=[],t=0;for(let n of u){let r=0,o=n.map(a=>{var l;let C=(l=e[t])!=null?l:"";t+=1,a.preprocess&&(C=a.preprocess(C)),Ju(C)>a.width&&(C=Xt(C,a.width,{hard:!0}));let F=C.split(`
`);if(a.postprocess){let{postprocess:c}=a;F=F.map((E,d)=>c.call(a,E,d))}return a.paddingTop&&F.unshift(...De(a.paddingTop)),a.paddingBottom&&F.push(...De(a.paddingBottom)),F.length>r&&(r=F.length),fu(eu({},a),{lines:F})}),s=[];for(let a=0;a<r;a+=1){let l=o.map(C=>{var F;let c=(F=C.lines[a])!=null?F:"",E=Number.isFinite(C.width)?" ".repeat(C.width-N(c)):"",d=C.paddingLeftString;return C.align==="right"&&(d+=E),d+=c,C.align==="left"&&(d+=E),d+C.paddingRightString}).join("");s.push(l)}D.push(s.join(`
`))}return D.join(`
`)}i(uD,"P$1");function eD(u,e){if(!u||u.length===0)return"";let D=Mt(u),t=D.length;if(t===0)return"";let{stdoutColumns:n,columns:r}=It(e);if(r.length>t)throw new Error(`${r.length} columns defined, but only ${t} columns found`);let o=zt(n,r,D);return u.map(s=>uD(o,s)).join(`
...
`)}}}}i(cD,"T");function fD(u){return!("commands"in u)||!u.commands?.length?void 0:{id:"commands",type:"section",data:{title:"Commands:",body:{type:"table",data:{tableData:u.commands.map(e=>[e.options.name,e.options.help?e.options.help.description:""]),tableOptions:[{width:"content-width",paddingLeft:2,paddingRight:8}]}},indentBody:0}}}i(fD,"_$1");function FD(u){if(!(!u.flags||Object.keys(u.flags).length===0))return{id:"flags",type:"section",data:{title:"Flags:",body:iD(u.flags),indentBody:0}}}i(FD,"k");function CD(u){const{help:e}=u;if(!e||!e.examples||e.examples.length===0)return;let{examples:D}=e;if(Array.isArray(D)&&(D=D.join(`
`)),D)return{id:"examples",type:"section",data:{title:"Examples:",body:D}}}i(CD,"F");function pD(u){if(!("alias"in u)||!u.alias)return;const{alias:e}=u;return{id:"aliases",type:"section",data:{title:"Aliases:",body:Array.isArray(e)?e.join(", "):e}}}i(pD,"H$1");const dD=i(u=>[aD,lD,cD,fD,FD,CD,pD].map(e=>e(u)).filter(Boolean),"U"),ED=qe.WriteStream.prototype.hasColors();let hD=class{static{i(this,"J")}text(e){return e}bold(e){return ED?`\x1B[1m${e}\x1B[22m`:e.toLocaleUpperCase()}indentText({text:e,spaces:D}){return e.replace(/^/gm," ".repeat(D))}heading(e){return this.bold(e)}section({title:e,body:D,indentBody:t=2}){return`${(e?`${this.heading(e)}
